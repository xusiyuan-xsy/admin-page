<template>
  <div class="app-container tree-sidebar-manage-wrap">
    ...
    <div class="tree-sidebar-content">
      <div class="content-inner">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="用户编号" align="center" key="id" prop="id" v-if="columns.id.visible" />
          <el-table-column label="用户名称" align="center" key="name" prop="name" v-if="columns.name.visible" :show-overflow-tooltip="true" />
          <el-table-column label="用户昵称" align="center" key="nickName" prop="nickName" v-if="columns.nickName.visible" :show-overflow-tooltip="true" />
          <el-table-column label="部门" align="center" key="deptName" prop="dept.deptName" v-if="columns.deptName.visible" :show-overflow-tooltip="true" />
          <el-table-column label="手机号码" align="center" key="phone" prop="phone" v-if="columns.phone.visible" width="120" />
    ...
    <el-dialog :title="title" v-model="open" width="720px" append-to-body>
      <el-form :model="form" :rules="rules" ref="payingUserRef" label-width="80px">
        <el-row>
          <el-col :span="12">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="图片上传">
              <image-upload v-model="form.images" action="/oss/upload" name="file" :limit="4" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
const data = reactive({
  ...
  rules: {
    name: [{ required: true, message: "用户名称不能为空", trigger: "blur" }, { min: 2, max: 20, message: "用户名称长度必须介于 2 和 20 之间", trigger: "blur" }],
  ...
  proxy.$refs["payingUserRef"].validate(valid => {
    if (valid) {
      if (form.value.userId != undefined) {
        updatePayingUser(form.value).then(() => {
          proxy.$modal.msgSuccess("修改成功")
          open.value = false
          getList()
        })
      } else {
        addPayingUser(form.value).then(() => {
